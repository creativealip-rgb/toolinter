...
export const suratTypes: SuratType[] = [
  ...
  },
  {
    ...
    description: "Buat surat izin tidak masuk kuliah karena sakit atau keperluan lain",
    icon: "graduation-cap",
    fields: [
      { name: "nama_mahasiswa", label: "Nama Mahasiswa", type: "text", placeholder: "Masukkan nama lengkap", required: true },
      { name: "nim", label: "NIM", type: "text", placeholder: "Masukkan Nomor Induk Mahasiswa", required: true },
      { name: "prodi", label: "Program Studi", type: "text", placeholder: "Contoh: Teknik Informatika", required: true },
      { name: "universitas", label: "Nama Universitas", type: "text", placeholder: "Contoh: Universitas Indonesia", required: true },
      { name: "semester", label: "Semester", type: "text", placeholder: "Contoh: 5", required: true },
      { name: "alasan", label: "Alasan Izin", type: "textarea", placeholder: "Contoh: karena sakit demam", required: true },
      { name: "tanggal", label: "Tanggal Izin", type: "date", required: true },
    ],
  },
  {
    ...
    description: "Buat surat izin tidak masuk kerja karena sakit atau keperluan mendesak",
    icon: "briefcase",
    fields: [
      { name: "nama", label: "Nama Lengkap", type: "text", placeholder: "Masukkan nama lengkap Anda", required: true },
      { name: "jabatan", label: "Jabatan", type: "text", placeholder: "Contoh: Staff Marketing", required: true },
      { name: "perusahaan", label: "Nama Perusahaan", type: "text", placeholder: "Contoh: PT ABC Indonesia", required: true },
      { name: "alasan", label: "Alasan Izin", type: "textarea", placeholder: "Contoh: karena sakit demam tinggi", required: true },
      { name: "tanggal_mulai", label: "Tanggal Mulai Izin", type: "date", required: true },
      { name: "tanggal_selesai", label: "Tanggal Selesai Izin", type: "date", required: true },
    ],
  },
  {
    slug: "kuasa-bpkb",
    title: "Surat Kuasa Pengambilan BPKB",
    description: "Buat surat kuasa untuk pengambilan BPKB kendaraan",
    icon: "car",
    fields: [
      { name: "pemberi_kuasa", label: "Nama Pemberi Kuasa", type: "text", placeholder: "Masukkan nama pemberi kuasa", required: true },
      { name: "nik_pemberi", label: "NIK Pemberi Kuasa", type: "text", placeholder: "Masukkan NIK pemberi kuasa", required: true },
      ...
      { name: "nik_penerima", label: "NIK Penerima Kuasa", type: "text", placeholder: "Masukkan NIK penerima kuasa", required: true },
      { name: "alamat_penerima", label: "Alamat Penerima Kuasa", type: "textarea", placeholder: "Masukkan alamat penerima kuasa", required: true },
      { name: "no_bpkb", label: "Nomor BPKB", type: "text", placeholder: "Masukkan nomor BPKB", required: true },
      { name: "no_polisi", label: "Nomor Polisi", type: "text", placeholder: "Contoh: B 1234 ABC", required: true },
    ],
  },
  {
    slug: "keterangan-usaha",
    title: "Surat Keterangan Usaha",
    description: "Buat surat keterangan usaha untuk keperluan administrasi dan perizinan",
    icon: "store",
    fields: [
      { name: "nama", label: "Nama Lengkap", type: "text", placeholder: "Masukkan nama lengkap Anda", required: true },
      { name: "nik", label: "NIK", type: "text", placeholder: "Masukkan Nomor Induk Kependudukan", required: true },
      { name: "alamat", label: "Alamat Domisili", type: "textarea", placeholder: "Masukkan alamat sesuai KTP", required: true },
      { name: "jenis_usaha", label: "Jenis Usaha", type: "text", placeholder: "Contoh: Warung Makan, Toko Kelontong", required: true },
      { name: "alamat_usaha", label: "Alamat Usaha", type: "textarea", placeholder: "Masukkan alamat lokasi usaha", required: true },
      { name: "lama_usaha", label: "Lama Usaha", type: "text", placeholder: "Contoh: 3 tahun", required: true },
    ],
  },
  {
    slug: "keterangan-tidak-mampu",
    title: "Surat Keterangan Tidak Mampu",
    description: "Buat surat keterangan tidak mampu untuk keperluan bantuan sosial atau beasiswa",
    icon: "heart",
    fields: [
      { name: "nama", label: "Nama Lengkap", type: "text", placeholder: "Masukkan nama lengkap Anda", required: true },
      { name: "nik", label: "NIK", type: "text", placeholder: "Masukkan Nomor Induk Kependudukan", required: true },
      ...
      { name: "penghasilan", label: "Penghasilan per Bulan", type: "text", placeholder: "Contoh: Rp 1.500.000", required: true },
      { name: "keperluan", label: "Keperluan", type: "textarea", placeholder: "Contoh: pengajuan beasiswa pendidikan", required: true },
    ],
  },
  {
    slug: "pengunduran-diri",
    title: "Surat Pengunduran Diri (Formal)",
    description: "Buat surat pengunduran diri formal dengan format resmi untuk keperluan HRD",
    icon: "log-out",
    fields: [
      { name: "nama", label: "Nama Lengkap", type: "text", placeholder: "Masukkan nama lengkap Anda", required: true },
      { name: "jabatan", label: "Jabatan", type: "text", placeholder: "Contoh: Staff Marketing", required: true },
      { name: "nip_nik", label: "NIP/NIK Karyawan", type: "text", placeholder: "Masukkan NIP atau NIK karyawan", required: true },
      { name: "perusahaan", label: "Nama Perusahaan", type: "text", placeholder: "Contoh: PT ABC Indonesia", required: true },
      { name: "tanggal_masuk", label: "Tanggal Masuk Kerja", type: "date", required: true },
      { name: "tanggal_berhenti", label: "Tanggal Berhenti Kerja", type: "date", required: true },
